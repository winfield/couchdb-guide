...
CouchDB的一个核心的假设便是, 错误可以发生, 比如网络连接中断了, 它被设计为可以优雅的进行错误恢复, 而不是假设所有事情都能顺利进行. 复制系统的增量设计最好的展示了这一点. "错误可以发生"背后的观点在[分布式计算的谬误](http://en.wikipedia.org/wiki/Fallacies_of_Distributed_Computing)这里有很好的解释:
